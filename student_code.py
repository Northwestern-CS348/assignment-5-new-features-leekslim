...
def buildFeatureStatement(tree):
    ...
    root = languageTools.extractRoot(tree)  # Your code to extractRoot here
...
##### Your code to extractSubject here
    ...
    list_of_names = core.resolveObjectFOPC(subj)  # Your code to resolveObjectFOPC here -- this will build some FOPC and Assert it
    ...
    core.findAndAttachPrepObjectsFOPC(root, subj, list_of_names)  # Your code to resolveObjectFOPC here -- this takes the root, the primary (suibject) and your names
    ...
    core.findAndAssertFeaturesFOPC(root, list_of_names) #  Your code to findAndAssertFeaturesFOPC here -- this takes the root and your names

    core.findAndAssertDefinitionsFOPC(root, list_of_names) #  Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names
